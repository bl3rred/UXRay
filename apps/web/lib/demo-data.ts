        ...
        runs: [
          {
            ...
            local_preview_url: seedRun.local_preview_url,
            public_preview_url: seedRun.public_preview_url,
...
function toRunSummary(run: RunDetail): RunSummary {
  return {
    ...
    local_preview_url: run.local_preview_url,
    public_preview_url: run.public_preview_url,
